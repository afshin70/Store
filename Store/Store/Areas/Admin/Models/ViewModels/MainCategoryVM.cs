...
namespace Store.Areas.Admin.Models.ViewModels
{
    ...
    public class MainCategoryAddVM
    {
    ...
    public class MainCategoryEditedVM
    {
        ...
        [Required(ErrorMessage = "فیلد {0} را وارد نکرده اید.", AllowEmptyStrings = false)]
        [MaxLength(100, ErrorMessage = "حداکثر طول {0}، {1} کاراکتر میباشد.")]
        [Remote(action: "CheckExistOneMainCategoryName", controller: "CheckData", areaName: "Admin", AdditionalFields = nameof(MainCategoryId), ErrorMessage = "مقدار فیلد {0} تکراری است.")]
        /// <summary>
        /// نام
        /// </summary>
        public string Name { get; set; }
        ...
        [Required(ErrorMessage = "فیلد {0} را وارد نکرده اید.", AllowEmptyStrings = false)]
        [MaxLength(100, ErrorMessage = "حداکثر طول {0}، {1} کاراکتر میباشد.")]
        [Remote(action: "CheckExistOneMainCategoryEName", controller: "CheckData", areaName: "Admin", AdditionalFields =nameof(MainCategoryId), ErrorMessage = "مقدار فیلد {0} تکراری است.")]
        /// <summary>
        /// نام انگلیسی
        /// </summary>
        public string EName { get; set; }
